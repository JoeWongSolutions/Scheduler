...
function refreshShifts(yearWeek) {
    ...
    xhttp.open("GET", "getBidShift.php?week="+yearWeek, true)
    xhttp.send()
}

$('#bidShiftModal').on('show.bs.modal', function (event) {
...
$(function() {
    ...
    $('#bid-tab').toggleClass("active")
    $('#bid-tab').attr("aria-selected", "true")
...
//        if(!confirm("Are you sure you want to BID for this shift?")){
//            event.preventDefault();
//        }
//    })
})